...
- `search_remote_catalog`
- `install_skill_from_url`
- `update_skills_from_registry`
...
### Testing
```bash
cargo test --package praxis-skills --lib
```


## Usage

As a library module, skills is typically used internally by the Praxis framework. 
Consult the source code and module documentation for specific usage patterns.

### Importing
In your Rust code:
```rust
use praxis::skills::*;  // or specific components as needed
```
...
*Documentation auto-generated for Praxis module `skills`*
