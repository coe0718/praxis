...
Dashboard module for Praxis AI agent framework
...
### Testing
```bash
cargo test --package praxis-dashboard --lib
```


## Usage

As a library module, dashboard is typically used internally by the Praxis framework. 
Consult the source code and module documentation for specific usage patterns.

### Importing
In your Rust code:
```rust
use praxis::dashboard::*;  // or specific components as needed
```
...
*Documentation auto-generated for Praxis module `dashboard`*
