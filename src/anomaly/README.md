...
### Testing
```bash
cargo test --package praxis-anomaly --lib
```


## Usage

As a library module, anomaly is typically used internally by the Praxis framework. 
Consult the source code and module documentation for specific usage patterns.

### Importing
In your Rust code:
```rust
use praxis::anomaly::*;  // or specific components as needed
```
...
*Documentation auto-generated for Praxis module `anomaly`*
