...
Report module for Praxis AI agent framework
...
### Testing
```bash
cargo test --package praxis-report --lib
```


## Usage

As a library module, report is typically used internally by the Praxis framework. 
Consult the source code and module documentation for specific usage patterns.

### Importing
In your Rust code:
```rust
use praxis::report::*;  // or specific components as needed
```
...
*Documentation auto-generated for Praxis module `report`*
