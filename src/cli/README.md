...
Cli module for Praxis AI agent framework
...
### Testing
```bash
cargo test --package praxis-cli --lib
```


## Usage

As a library module, cli is typically used internally by the Praxis framework. 
Consult the source code and module documentation for specific usage patterns.

### Importing
In your Rust code:
```rust
use praxis::cli::*;  // or specific components as needed
```
...
*Documentation auto-generated for Praxis module `cli`*
